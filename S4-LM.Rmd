...
Secondly, for $structure$ and $production$ variables models \@ref(eq:m1) and \@ref(eq:m2) gives similar results, at the exception of the effect of $FDis.LMA$ in $production$ resilience. So I think we can keep only model \@ref(eq:m2) keeping in mind the effect of $FDis.LMA$ on $production$.
