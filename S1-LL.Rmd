...
link-citations: yes
gdoc_id: 1G5GQy7yxmwSsUCcC_Exky_cPYDhwHxNcVXnnILdPAUs
---
...
Leaf lifespan $LL$ follows a log-normal law with location inferred from leaf lifespan $LMA$, nitrogen content $N$ and wood specific gravity $wsg$ and a scale $\sigma$. Each ${\beta_i}_d$ is following a normal law located on $\beta_i$ with a scale of $\sigma_i$. All $\beta_i$, $\sigma_i$, and $\sigma$ are assumed without preemption following a gamma law. $d$ represents the dataset random effects and encompass environmental and protocol variations.
