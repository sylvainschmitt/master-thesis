...
BEresilience %>% 
  ...
  facet_grid(disturbance ~ richness, labeller = 'label_both') +
  xlab('Time (years)') +
...
* Supplementary materials S1: Leaf lifespan model
    + [HTML](S1-LL.html)
    + [PDF](S1-LL.pdf)
* Supplementary materials S2: Resilience indice
